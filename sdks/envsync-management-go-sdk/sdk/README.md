...
import (
    client "github.com/envsync-cloud/envsync-management-go-sdk/sdk/client"
...
func do() () {
    ...
    client.Onboarding.CreateOrgInvite(
        context.TODO(),
        &sdk.CreateOrgInviteRequest{
            Email: "email",
        },
    )
}
...
```go
response, err := client.Onboarding.CreateOrgInvite(...)
if err != nil {
...
response, err := client.Onboarding.CreateOrgInvite(ctx, ...)
```
